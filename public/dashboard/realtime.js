async function initDoors() {
    ...
    const res = await fetch('http://127.0.0.1:8080/infos/doors', {
...
function updateTable(data) {
    ...
    if (data.temperature !== null && data.temperature !== undefined) {
        ...
        if (temp < 19) { colorClass = 'text-primary'; icon = 'bi-thermometer-snow'; }
        else if (temp > 28) { colorClass = 'text-danger'; icon = 'bi-thermometer-sun'; }
